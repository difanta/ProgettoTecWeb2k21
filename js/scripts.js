...
var dettagli_form = {
    ...
    "regista": ["inserisci il/la regista del film", /[a-zA-Zàèéìòù]{1,}/, "il campo deve contenere almeno un carattere alfabetico"],
    "produttore": ["inserisci il/la produttore/produttrice del film", /[a-zA-Zàèéìòù]{1,}/, "il campo deve contenere almeno un carattere alfabetico"],
    ...
    "alfaRegisti": ["inserisci il/la regista del film", /[a-zA-Zàèéìòù]{1,}/, "il campo deve contenere almeno un carattere alfabetico"],
    "alfaProduttore": ["inserisci il/la produttore/produttrice del film", /[a-zA-Zàèéìòù]{1,}/, "il campo deve contenere almeno un carattere alfabetico"],
    ...
    "alfmRegisti": ["inserisci il/la regista del film", namesregex, "il campo deve contenere almeno un carattere alfabetico"],
    "alfmProduttore": ["inserisci il/la produttore/produttrice del film", namesregex, "il campo deve contenere almeno un carattere alfabetico"],
