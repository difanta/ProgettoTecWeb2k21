    ...
    if($connectionOk) {
        ...
        if($result) {
            ...
            foreach($result as $indice => $film) {
                ...
                $proiezione_html = str_replace("ogdata",         Sanitizer::forHtml($film[0]["data"]), $proiezione_html);
                $proiezione_html = str_replace("ogora",          Sanitizer::forHtml($film[0]["ora"]),  $proiezione_html);
