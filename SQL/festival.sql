...
('Gilberto Filé - L\'addio', 'Due grandi amici del celebre professore Unipd celebrano il suo ritiro ricordando vari momenti classici della vita dell\'egregio professor Filé.\r Tra gossip e storie piccanti, il percorso didattico del professore storico di Informatica Unipd viene descritto con zelo e precisione senza precedenti.', 120, 2020, 'Alessandro Sperduti, Caterina Sartori', 'Unipd', 'Vari membri dell\'università di Padova', 1, 1, 11),
...
("Le notti di Cabiria", "Una gracile prostituta si aggira per le strade di Roma in cerca del vero amore ma trova solamente delusioni.", 110, 1957, "Federico Fellini", "De Laurentiis", "Giulietta Masina; Francois Perier", 0, 1, null),
("Nuovo cinema Paradiso", "Un regista ricorda la propria infanza in un piccolo villagio italiano in cui è cresciuto innamorandosi dell'arte del cinema e stringedo amicizia con il proiezionista del cinema locale.", 173, 1988, "Giuseppe Tornatore", "Cristaldifilms", "Salvatore Cascio; Philippe Noiret", 0, 1, null),
("Midsommar", "Una coppia giunge in Svezia per la tradizionale festa di mezza estate che si celebra sul posto. Quella che doveva essere una vacanza paradisiaca si trasformerà presto in una violenta e curiosa competizione per via di un culto pagano.", 148, 2019, "Ari Aster", "B-Reel Films", "Florence Pugh; Jack Reynor; Villhelm Blomgren", 0, 1, null),
("La parola ai giurati", "Un membro della giuria tenta di impedire un errore giudiziario costringendo i suoi colleghi a riesaminare le prove.", 96, 1957, "Sidney Lumet", "Big productions", "Henry Fonda; Lee J. Cobb", 0, 1, null),
("Il dottor Stranamore", "Un generale pazzo avvia una percorso che conduce all'olocausto nucleare, mentre un Comando Strategico di numerosi politici e generali cerca affannosamente di fermarlo.", 95, 1964, "Stanley Kubrick", "Columbia Pictures", "Peter Sellers", 0, 1, null),
("The Florida Project", "La trama si svolge nel corso di un'estate e segue la precoce bambina di sei anni Moonee che combina monellerie e si lancia in avventure con i suoi improvvisati amici di giochi e costruisce il legame con la sua madre ribelle ma affezionata, il tutto mentre vivono all'ombra del Walt Disney World.", 111, 2017, "Sean Baker", "Cre Film", "Brooklynn Prince; Bria Vinaite", 0, 1, null),
("Arrival", "Una linguista viene reclutata dall'esercito per comunicare con forme di vita aliene dopo che dodici misteriose navicelle spaziali sono atterrate sul nostro pianeta.", 116, 2016, "Denis Villeneuve", "Lava Bear Films", "Amy Adams; Jeremy Renner", 0, 1, null);
